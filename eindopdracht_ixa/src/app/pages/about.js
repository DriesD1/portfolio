...
export default function AboutPage() {
  ...
  return (
    <>
      {loading && <p>Loading...</p>}
      {data && data.abouts && data.abouts.length > 0 && (
            ...
            <div className="flex lg:justify-around items-center flex-wrap">
              <div className="w-full max-w-[80rem] lg:max-w-[20rem]">
                <img
                  ...
                  alt={about.title}
                />
                {dataSongs && dataSongs.songs && dataSongs.songs.length > 0 && (
                  dataSongs.songs.map((song) => (
                    <a className="flex gap-5 bg-standard-grey lg:max-w-[20rem] w-full max-w-[80%] mx-auto items-center  p-3" target="_blank" href={`https://open.spotify.com/${song.slug}`}>
                      <div>
                      <svg height="50px" width="50px" viewBox="0 0 48 48" fill="#000000">
                        <g id="Icons" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                          <g id="Color-" transform="translate(-200.000000, -460.000000)" fill="#F8EBD5">
              ...
              <div className="max-w-full w-[40rem]">
                ...
                <p className="text-standard-brokenWhite lg:text-[20px] text-[16px]">{about.moreInfo.text}</p>
              </div>
            </div>
          </section>
        ))
      ...
      <section className="m-[3rem]">
        ...
        {dataSkills && dataSkills.skills && dataSkills.skills.length > 0 && (
          dataSkills.skills.map((skill) => (
            <div className={`bg-standard-grey flex items-center rounded-[10rem] h-[5rem] max-w-[${skill.percentage}] w-full mt-[2rem]`}>
